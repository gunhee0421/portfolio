...
const ProjectSection = () => {
  return (
    <div>
      ...
      <div
        id="Gdg"
        className="px-8 sm:px-[4rem] md:px-[4rem] lg:px-[5rem] xl:[7rem] 2xl:px-[15rem] bg-[#9097C0]"
      >
        <section id="project" className="h-screen py-[50px] sm:py-[12dvh]">
          <div className="flex flex-col h-full w-full text-white">
            <div className=" flex flex-row justify-between">
      ...
      <div
        id="ladi"
        className="px-8 sm:px-[4rem] md:px-[4rem] lg:px-[5rem] xl:[7rem] 2xl:px-[15rem] bg-[#1666DB]"
      >
        <section id="project" className="h-screen py-[50px] sm:py-[12dvh]">
          <div className="flex flex-col h-full w-full text-white">
            <div className=" flex flex-row justify-between">
