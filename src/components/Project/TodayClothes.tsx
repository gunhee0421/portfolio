    ...
    <div className="w-full flex flex-row lg:justify-around h-[70dvh] font-toss">
      <div className="flex flex-col justify-around lg:w-1/2 h-full">
        ...
        <ol className="grid grid-cols-2 gap-4 w-full lg:flex lg:flex-row lg:justify-between pt-4">
          ...
          <li>
            <TitleLabel title="기간" />
            <ContentLabel>2024.09 ~ 2024.11</ContentLabel>
          </li>
          <li>
          ...
          <li>
            ...
            <ContentLabel>Rang Chain</ContentLabel>
          </li>
        </ol>
        <div>
          <TitleLabel title="소개" />
          <ol className="list-disc pl-5">
            <li>
              <ContentLabel>
                최신 트렌드의 옷차림 추천 서비스 입니다.
              </ContentLabel>
            </li>
            <li>
              <ContentLabel>
                TPO(시간, 장소, 상황)에 맞는 옷차림 추천 서비스 입니다.
              </ContentLabel>
            </li>
            <li>
              <ContentLabel>
                사용자 추천 기록을 통한 개인화된 의상 추천 서비스 입니다.
              </ContentLabel>
            </li>
          </ol>
        </div>
        <div>
          ...
          <div className="flex flex-row gap-2">
            <div
              onClick={() => {
                setSelectedImage('/images/project/todayclothes/one.png')
                openModal()
              }}
              className="w-1/3 cursor-pointer h-full"
            >
              <Image
                src={'/images/project/todayclothes/one.png'}
                alt="주요 사진 1"
                width={200}
                height={400}
            ...
            <div
              onClick={() => {
                setSelectedImage('/images/project/todayclothes/two.png')
                openModal()
              }}
              className="w-1/3 cursor-pointer"
            >
              <Image
                src={'/images/project/todayclothes/two.png'}
                alt="주요 사진 1"
                width={200}
                height={400}
            ...
            <div
              onClick={() => {
                setSelectedImage('/images/project/todayclothes/three-max.png')
                openModal()
              }}
              className="w-1/3 cursor-pointer"
            >
              <Image
                src={'/images/project/todayclothes/three.png'}
                alt="주요 사진 1"
                width={200}
                height={400}
                className="w-full rounded-md "
      ...
      <div className="m-auto hidden lg:block bg-white brightness-75 hover:brightness-100 transition-all duration-500">
        <Image
          src={'/images/project/todayclothes/home.png'}
          alt="image"
          width={350}
          height={500}
