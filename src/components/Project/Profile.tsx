    ...
    <div className="w-full flex flex-row lg:justify-around h-[70dvh] font-toss">
      <div className="flex flex-col justify-around lg:w-1/2 h-full">
        ...
        <ol className="grid grid-cols-2 gap-4 w-full lg:flex lg:flex-row lg:justify-between pt-4">
          ...
          <li>
            <TitleLabel title="기간" />
            <ContentLabel>2025.01 ~ 현재</ContentLabel>
          </li>
          <li>
        ...
        <div>
          ...
          <ol className="list-disc pl-5">
            <li>
              <ContentLabel>조건희를 소개하는 페이지 입니다.</ContentLabel>
            </li>
          </ol>
        </div>
        <div>
          ...
          <div className="flex flex-row gap-2">
            <div
              onClick={() => {
                setSelectedImage('/images/project/profile/one.png')
                openModal()
              }}
              className="w-1/3 cursor-pointer h-full"
            >
              <Image
                src={'/images/project/profile/one.png'}
                alt="주요 사진 1"
                width={200}
                height={400}
            ...
            <div
              onClick={() => {
                setSelectedImage('/images/project/profile/two.png')
                openModal()
              }}
              className="w-1/3 cursor-pointer"
            >
              <Image
                src={'/images/project/profile/two.png'}
                alt="주요 사진 1"
                width={200}
                height={400}
            ...
            <div
              onClick={() => {
                setSelectedImage('/images/project/profile/three.png')
                openModal()
              }}
              className="w-1/3 cursor-pointer"
            >
              <Image
                src={'/images/project/profile/three.png'}
                alt="주요 사진 1"
                width={200}
                height={400}
                className="w-full rounded-md"
        ...
        <div className="w-full flex flex-row gap-2">
          <Link href="https://gunhee.store/" className="w-full h-12">
      ...
      <div className="m-auto hidden lg:block bg-white brightness-75 hover:brightness-100 transition-all duration-500">
        <Link href="https://gunhee.store/">
          <Image
            src={'/images/project/profile/home.png'}
            alt="image"
            width={350}
            height={500}
